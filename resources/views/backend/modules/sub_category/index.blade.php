            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('sub-category.create') }}"><button class="btn btn-success btn-sm">Add</button></a>
                    </div>
                </div>
                <div class="card-body">
                    @if (session('msg'))
                            ...
                            <tbody>
                                @foreach ($sub_categories as $sub_category)
                                    <tr>
                                        ...
                                        <td>{{ $sub_category->created_at != $sub_category->updated_at ? $sub_category->updated_at->toDayDateTimeString() : 'No Updated' }}
                                        </td>
                                        <td>
                                            <div class="d-flex">
